...
export const LoginSignup = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:8080/page/register", formData, {
        headers: {
          "Content-Type": "application/json",
        },
      });
      console.log("Registration successful:", response.data);
      navigate("/page/login"); // Navigate to the login page after successful registration
    } catch (error) {
